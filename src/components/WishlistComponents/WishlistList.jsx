...
const Wishlist = () => {
  ...
  useEffect(() => {
    const fetchWishlist = async () => {
      try {
        setIsLoading(true);
        const response = await axios.get(`http://${import.meta.env.VITE_API_URL}/api/wishlist/${userId}`);
  ...
  const handleDelete = async (itemId) => {
    try {
      await axios.delete(`http://${import.meta.env.VITE_API_URL}/api/wishlist/${userId}/${itemId}`);
